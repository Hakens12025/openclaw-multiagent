...
export async function buildContractSessionSystemPrompt({
  ...
  return [
    ...
    "- Runtime consumes status metadata; your reply carries the user-facing answer, and a file artifact carries it when the task asks for one.",
    "- `primaryArtifactPath` points to the main user-facing artifact when the round produced one.",
    "",
    "## Tools",
    "",
