...
} from "../../agent/admin/agent-join-admin.js";
import {
...
import { startTestRun } from "../../formal-runtime/test-runs.js";
import { normalizeTestRunCleanMode } from "../../formal-runtime/test-run-presets.js";
import { dispatchAcceptIngressMessage } from "../../ingress/dispatch-entry.js";
import { normalizeQQIngressSource } from "../../routing/qq-reply-target.js";
...
import { buildWikiRagIndex } from "../../knowledge/wiki-rag-store.js";
import { buildKbIndex } from "../../knowledge/knowledge-base.js";
import {
  addKnowledgeBaseSource,
  removeKnowledgeBaseSource,
  removeKnowledgeBase,
  configureKnowledgeBase,
} from "../../knowledge/knowledge-base-registry.js";
import { saveKnowledgeEvalSet, deleteKnowledgeEvalSet } from "../../knowledge/knowledge-eval-registry.js";
import { runKnowledgeEval, runKnowledgeFaithfulness } from "../../knowledge/knowledge-eval-runner.js";
import { createChartDefinition, moveChartPosition, deleteChartDefinition } from "../chart-operations.js";
...
const ADMIN_SURFACE_OPERATION_HANDLERS = Object.freeze({
  ...
  "apply.chart_delete": deleteChartDefinition,
