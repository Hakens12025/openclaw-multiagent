// lib/contract/contract-lifecycle-view.js — Lifecycle snapshot assembly & decoration
...
// 双源装配:树合约正本(contract-store 经 contract-index 定址)为主源,tracker 只叠加
// live 进行中会话的瞬时态(过程字段随 run 归档进树,终局读面在树账/封条)。
