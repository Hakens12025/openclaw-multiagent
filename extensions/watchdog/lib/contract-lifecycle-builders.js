// lib/contract-lifecycle-builders.js — Snapshot construction helpers for lifecycle assembly
...
export function historyEntryToLifecycleSnapshot(entry) {
  ...
  const snapshot = buildLifecycleSnapshotFromWorkItem({
    ...
    ioObservation: entry.ioObservation || workItem?.ioObservation || null,
