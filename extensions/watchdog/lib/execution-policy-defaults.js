...
// Tiers (monotone bridge < planner/reviewer < agent < executor/researcher):
//   bridge     15  hook-locked forwarder (controller / qq-bridge): read inbox,
//                  relay to outbox — a handful of tool calls suffices.
//   reviewer   30  read-mostly: reads diffs/artifacts, emits a verdict.
...
const ROLE_POLICY = Object.freeze({
  ...
  [AGENT_ROLE.REVIEWER]: Object.freeze({ maxToolCalls: 30 }),
