import { normalizeManagementActivityTargetSummary } from "../admin/change-sets/admin-change-set-management.js";
...
function normalizeAutomationSummary(automation) {
  // harness 塑形/判决投影已随 harness 全退役删除（v226 / 2026-08-23，备忘录149 batch3）。
  return {
