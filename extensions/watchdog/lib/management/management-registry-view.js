...
} from "../admin/change-sets/admin-change-set-management.js";
import {
...
} from "./capability-management-targets.js";
...
const MANAGEMENT_SUMMARIES = Object.freeze({
  ...
  automation: "Long-running automation objectives and runtime state.",
